...
- [execution-ledger.test.cjs](../../scripts/tests/execution-ledger.test.cjs) → [execution-ledger.cjs](../../skills/project-retrospective/scripts/execution-ledger.cjs)
...
- [prior-evidence.test.cjs](../../scripts/tests/prior-evidence.test.cjs) → [prior-evidence.cjs](../../skills/project-retrospective/scripts/prior-evidence.cjs)
...
- [source-parity.test.cjs](../../scripts/tests/source-parity.test.cjs) → [source-parity.cjs](../../skills/project-retrospective/scripts/source-parity.cjs)
...
- [graph/build-graph.cjs](../../scripts/graph/build-graph.cjs) → [wiki/lib/frontmatter.cjs](../../scripts/wiki/lib/frontmatter.cjs), [wiki/lib/github.cjs](../../scripts/wiki/lib/github.cjs)
- [graph/routing.cjs](../../scripts/graph/routing.cjs) → [wiki/lib/github.cjs](../../scripts/wiki/lib/github.cjs)
...
- [execution-ledger.test.cjs](../../scripts/tests/execution-ledger.test.cjs) → [helpers.cjs](../../scripts/tests/helpers.cjs), [execution-ledger.cjs](../../skills/project-retrospective/scripts/execution-ledger.cjs)
- [inventory.test.cjs](../../scripts/tests/inventory.test.cjs) → [helpers.cjs](../../scripts/tests/helpers.cjs), [cms-taxonomy.cjs](../../skills/project-retrospective/scripts/lib/cms-taxonomy.cjs)
...
- [prior-evidence.test.cjs](../../scripts/tests/prior-evidence.test.cjs) → [helpers.cjs](../../scripts/tests/helpers.cjs)
...
- [source-parity.test.cjs](../../scripts/tests/source-parity.test.cjs) → [helpers.cjs](../../scripts/tests/helpers.cjs)
...
- [validate-report.test.cjs](../../scripts/tests/validate-report.test.cjs) → [helpers.cjs](../../scripts/tests/helpers.cjs), [execution-ledger.cjs](../../skills/project-retrospective/scripts/execution-ledger.cjs)
- [wiki-standard.test.cjs](../../scripts/tests/wiki-standard.test.cjs) → [graph/build-graph.cjs](../../scripts/graph/build-graph.cjs), [graph/pre-commit.cjs](../../scripts/graph/pre-commit.cjs), [graph/routing.cjs](../../scripts/graph/routing.cjs), [wiki/lib/github.cjs](../../scripts/wiki/lib/github.cjs), [wiki/on-merge-sync.cjs](../../scripts/wiki/on-merge-sync.cjs), [wiki/refresh-issue-state.cjs](../../scripts/wiki/refresh-issue-state.cjs)
...
- [wiki/on-merge-sync.cjs](../../scripts/wiki/on-merge-sync.cjs) → [wiki/lib/ai.cjs](../../scripts/wiki/lib/ai.cjs), [wiki/lib/frontmatter.cjs](../../scripts/wiki/lib/frontmatter.cjs), [wiki/lib/github.cjs](../../scripts/wiki/lib/github.cjs), [wiki/lib/substantive.cjs](../../scripts/wiki/lib/substantive.cjs), [wiki/lib/wiki-io.cjs](../../scripts/wiki/lib/wiki-io.cjs)
...
- [wiki/refresh-issue-state.cjs](../../scripts/wiki/refresh-issue-state.cjs) → [wiki/lib/github.cjs](../../scripts/wiki/lib/github.cjs)
...
- [capture-preflight.cjs](../../skills/project-retrospective/scripts/capture-preflight.cjs) → [util.cjs](../../skills/project-retrospective/scripts/lib/util.cjs), [source-parity.cjs](../../skills/project-retrospective/scripts/source-parity.cjs)
- [execution-ledger.cjs](../../skills/project-retrospective/scripts/execution-ledger.cjs) → [util.cjs](../../skills/project-retrospective/scripts/lib/util.cjs)
- [inventory.cjs](../../skills/project-retrospective/scripts/inventory.cjs) → [cms-taxonomy.cjs](../../skills/project-retrospective/scripts/lib/cms-taxonomy.cjs), [util.cjs](../../skills/project-retrospective/scripts/lib/util.cjs)
...
- [prior-evidence.cjs](../../skills/project-retrospective/scripts/prior-evidence.cjs) → [cms-taxonomy.cjs](../../skills/project-retrospective/scripts/lib/cms-taxonomy.cjs), [util.cjs](../../skills/project-retrospective/scripts/lib/util.cjs)
- [resolve.cjs](../../skills/project-retrospective/scripts/resolve.cjs) → [util.cjs](../../skills/project-retrospective/scripts/lib/util.cjs)
- [source-parity.cjs](../../skills/project-retrospective/scripts/source-parity.cjs) → [util.cjs](../../skills/project-retrospective/scripts/lib/util.cjs)
...
- [validate-report.cjs](../../skills/project-retrospective/scripts/validate-report.cjs) → [execution-ledger.cjs](../../skills/project-retrospective/scripts/execution-ledger.cjs), [cms-taxonomy.cjs](../../skills/project-retrospective/scripts/lib/cms-taxonomy.cjs), [util.cjs](../../skills/project-retrospective/scripts/lib/util.cjs), [source-parity.cjs](../../skills/project-retrospective/scripts/source-parity.cjs)
...
- [Knowledge graph & context wiki — Design History](../../wiki/topics/graph-wiki-subsystem.md) → [evals/graph-check.cjs](../../scripts/evals/graph-check.cjs), [Knowledge graph](../../scripts/graph/README.md), [graph/build-graph.cjs](../../scripts/graph/build-graph.cjs), [graph/pre-commit.cjs](../../scripts/graph/pre-commit.cjs), [graph/routing.cjs](../../scripts/graph/routing.cjs), [graph/serve.cjs](../../scripts/graph/serve.cjs), [wiki/lib/github.cjs](../../scripts/wiki/lib/github.cjs), [wiki/on-merge-sync.cjs](../../scripts/wiki/on-merge-sync.cjs), [wiki/refresh-issue-state.cjs](../../scripts/wiki/refresh-issue-state.cjs), [Wiki Mechanics](../../wiki/MECHANICS.md)
- [Library capture — Design History](../../wiki/topics/library-capture.md) → [Library integrity checklist](../../skills/project-retrospective/references/library-integrity-checklist.md), [Proposal template — component capture](../../skills/project-retrospective/references/proposal-component-capture-template.md), [Source-parity inventory](../../skills/project-retrospective/references/source-parity.md), [capture-preflight.cjs](../../skills/project-retrospective/scripts/capture-preflight.cjs), [source-parity.cjs](../../skills/project-retrospective/scripts/source-parity.cjs)
- [Retrospective workflow — Design History](../../wiki/topics/retrospective-workflow.md) → [project-retrospective](../../skills/project-retrospective/SKILL.md), [CMS taxonomy](../../skills/project-retrospective/references/cms-taxonomy.md), [Code-scan mode](../../skills/project-retrospective/references/code-scan-mode.md), [Evidence rubric](../../skills/project-retrospective/references/evidence-rubric.md), [Deterministic execution ledger](../../skills/project-retrospective/references/execution-ledger.md), [Authorized publication and exact handoff](../../skills/project-retrospective/references/publication-handoff.md), [Source-parity inventory](../../skills/project-retrospective/references/source-parity.md), [Spec capture](../../skills/project-retrospective/references/spec-capture.md), [Team retrospective capture](../../skills/project-retrospective/references/team-retrospectives.md), [Tracking issues and local branches](../../skills/project-retrospective/references/tracking-issues.md), [adf-to-markdown.cjs](../../skills/project-retrospective/scripts/adf-to-markdown.cjs), [execution-ledger.cjs](../../skills/project-retrospective/scripts/execution-ledger.cjs), [inventory.cjs](../../skills/project-retrospective/scripts/inventory.cjs), [cms-taxonomy.cjs](../../skills/project-retrospective/scripts/lib/cms-taxonomy.cjs), [normalize-retrospectives.cjs](../../skills/project-retrospective/scripts/normalize-retrospectives.cjs), [normalize-specs.cjs](../../skills/project-retrospective/scripts/normalize-specs.cjs), [prior-evidence.cjs](../../skills/project-retrospective/scripts/prior-evidence.cjs), [resolve.cjs](../../skills/project-retrospective/scripts/resolve.cjs), [source-parity.cjs](../../skills/project-retrospective/scripts/source-parity.cjs), [tracking-targets.cjs](../../skills/project-retrospective/scripts/tracking-targets.cjs), [update-retrospective-register.cjs](../../skills/project-retrospective/scripts/update-retrospective-register.cjs), [validate-report.cjs](../../skills/project-retrospective/scripts/validate-report.cjs)
