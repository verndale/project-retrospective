...
Totals: 14 implemented · 1 partial (15 plans).

## Plans

| Date | Plan | Status | Evidence | Topics |
| --- | --- | --- | --- | --- |
| 2026-09-06 | [Source-first retrospective knowledge loop](2026-09-06-source-first-knowledge-loop.md) | implemented | [verndale/project-retrospective issue #90](https://github.com/verndale/project-retrospective/issues/90), working tree tests, [verndale/project-retrospective PR #91](https://github.com/verndale/project-retrospective/pull/91) | retrospective-workflow, library-capture |
...
| 2026-08-21 | [Governed Figma Interaction States and Retrospective Capture](2026-08-21-governed-figma-interaction-states-and-retrospective-capture.md) | implemented | issue #78, working tree tests, authenticated live Figma audit of 28 registered nodes, [verndale/project-retrospective PR #82](https://github.com/verndale/project-retrospective/pull/82) | library-capture |
