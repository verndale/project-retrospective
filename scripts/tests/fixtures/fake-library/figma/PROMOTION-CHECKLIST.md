...
Name one live precedent before writing and record its sections in figma.presentationEvidence.
Use the authoritative code-parity variable collection and record state requirements in figma.tokenBindingAudit.
